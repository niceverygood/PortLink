...
const CAPTIONS: Record<number, Caption> = {
  1: { top: '안전운임 이상인지 한 번에 확인', bottom: '국토교통부 고시 자동 반영' },
  2: { top: '출발·상차·하차 1탭 보고', bottom: '위치는 동의한 시점 1회만' },
  3: { top: '주선사가 알려주지 않던 권리', bottom: '공차 운행 청구 양식 자동 제공' },
  4: { top: '미지급 신고서 PDF 즉시 발급', bottom: '참고 자료 — 발송 책임은 본인에게' },
  5: { top: '정산 내역 한눈에', bottom: '세금계산서 자동 발급' },
};
